  ...
  static List<Goal> createDemoGoals() {
    ...
    return [
      Goal(
        ...
        description: 'Build a 6-month emergency fund in cash reserves',
        targets: {AppConstants.typeCash: 30000.0},
      ...
      Goal(
        ...
        description: 'Reach \$1M across stocks, real estate and cash',
        targets: {
          AppConstants.typeStocksAndETFs: 500000.0,
          AppConstants.typeRealEstate: 300000.0,
          AppConstants.typeCash: 200000.0,
        },
        targetDate: now.add(const Duration(days: 365 * 5)),
        createdAt: now.subtract(const Duration(days: 60)),
      ),
      Goal(
        id: 'goal-3',
        title: 'Crypto Moon',
        description: 'Build a strong crypto position',
        targets: {AppConstants.typeCrypto: 50000.0},
      ...
      Goal(
        ...
        description: 'Save for a house down payment across liquid assets',
        targets: {
          AppConstants.typeCash: 100000.0,
          AppConstants.typeStocksAndETFs: 50000.0,
        },
        targetDate: now.add(const Duration(days: 365 * 3)),
